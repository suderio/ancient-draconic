...
var Lexer = lexer.MustSimple([]lexer.SimpleRule{
	{Name: "Keyword", Pattern: `(?i)\b(?:roll|encounter|start|end|with|and|add|initiative|by|attack|damage|turn|to|dice|hint|ask|check|of|dc|fails|succeeds|half|type|help|all)\b`},
